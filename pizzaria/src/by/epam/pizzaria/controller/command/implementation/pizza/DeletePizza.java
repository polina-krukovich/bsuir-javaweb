...
public class DeletePizza implements Command {

    /**
     * Execute Delete Pizza command
    ...
    public Response execute(Request request) {
        ...
        try {
            pizzaService.deletePizza(pizzaRequest.getId());
        } catch (ServiceException e) {
            pizzaResponse.setErrorMessage(e.getMessage());
            pizzaResponse.setStatus(CommandStatus.ERROR);
            return pizzaResponse;
        }
        pizzaResponse.setSuccessMessage("Successfully deleted pizza");
