...
public class UpdatePizzaDescription implements Command {
    /**
     * Execute Update Pizza Description command
    ...
    public Response execute(Request request) {
        ...
        try {
            pizzaService.updatePizzaDescription(pizzaRequest.getId(), pizzaRequest.getDescription());
        } catch (ServiceException e) {
            pizzaResponse.setErrorMessage(e.getMessage());
            pizzaResponse.setStatus(CommandStatus.ERROR);
            return pizzaResponse;
        }
        pizzaResponse.setSuccessMessage("Successfully updated pizza description");
